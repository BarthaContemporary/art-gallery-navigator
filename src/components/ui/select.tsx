...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "text-[#455118] hover:bg-[#e8c858] hover:text-black transition-colors",
      className
    )}
    {...props}
  >
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "text-[#455118] hover:bg-[#e8c858] hover:text-black focus:bg-[#e8c858] focus:text-black transition-colors",
      className
    )}
    {...props}
  >
