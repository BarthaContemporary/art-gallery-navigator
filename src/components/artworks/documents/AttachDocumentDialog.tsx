...
import { FileText, Search, Link, Database, ExternalLink } from 'lucide-react';
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[85vh] h-[85vh] min-h-0 flex flex-col">
        <DialogHeader>
          <DialogTitle>Attach Documents & Link Files</DialogTitle>
        </DialogHeader>
        ...
        <div className="flex-1 min-h-0 space-y-4 flex flex-col">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col min-h-0">
            ...
            <TabsContent value="shared" className="flex-1 flex flex-col min-h-0 space-y-4">
              {/* Navigation */}
