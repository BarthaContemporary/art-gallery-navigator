          ...
          <div className="flex flex-col space-y-2 flex-grow">
            {isAdmin ? (
              <button
                type="button"
                onClick={handleEditClick}
                className="text-base font-bold leading-tight underline text-[#18465a] hover:text-[#455118] transition-colors focus:outline-none w-full text-left"
                aria-label={`Edit ${artist.full_name}`}
                style={{
              ...
              <h3 className="font-bold text-base text-[#18465a] leading-tight w-full">
                {artist.full_name}
              </h3>
            )}
