...
import { useIDriveStorage } from '@/hooks/use-idrive-storage';
import { toast } from 'sonner';

export function IDriveFileManager() {
      ...
      <Card>
        <CardContent className="p-6">
          <p className="text-center text-muted-foreground">
            Storage not configured for your account. Please contact the administrator.
          </p>
        </CardContent>
      </Card>
    );
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="flex items-center gap-2">
              ...
              My Files
              <Badge variant="outline">{credentials.bucket_name}</Badge>
            </CardTitle>
