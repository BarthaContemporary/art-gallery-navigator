...
import { Home, Palette, Users, FileText, Calendar, MapPin, FolderOpen, Share2, Settings, Archive, Bell } from "lucide-react";
...
export function Navigation() {
  ...
  const adminNavItems = [
    ...
    { href: "/admin/notifications", icon: Bell, name: "Push Notifications" },
