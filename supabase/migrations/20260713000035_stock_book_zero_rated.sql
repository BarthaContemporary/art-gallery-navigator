-- 0035_stock_book_zero_rated
-- Zero-rated items in the stock book. No output VAT is due, but import VAT paid
-- is still reclaimable input VAT — recorded here for the accountant.

create or replace view public.vw_stock_book_zero_rated
...
where f.vat_treatment = 'zero_rated';

grant select on public.vw_stock_book_zero_rated to authenticated;
