...
PERFORM public.enhanced_log_security_event(
  'storage_credentials_secured',
  'critical',
  NULL,
  NULL,
  jsonb_build_object(
    'action', 'enabled_rls_on_decrypted_views',
    'tables_secured', ARRAY['admin_storage_credentials_decrypted', 'artist_storage_credentials_decrypted', 'shared_storage_credentials_decrypted'],
    'timestamp', NOW(),
