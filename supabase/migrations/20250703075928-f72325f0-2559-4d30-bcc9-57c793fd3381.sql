-- Update validate_webdav_token to use pgcrypto digest function consistently
...
BEGIN
    ...
    -- This uses pgcrypto digest function with proper text input
    BEGIN
        computed_hash := encode(digest(token_text::bytea, 'sha256'), 'hex');
