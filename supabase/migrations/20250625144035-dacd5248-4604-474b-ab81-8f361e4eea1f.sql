...
-- Drop the existing view that has the SECURITY DEFINER property
DROP VIEW IF EXISTS public.artist_folder_overview;

-- Recreate the view without SECURITY DEFINER (views cannot have this property)
