...
CREATE POLICY "Only admins can manage artist storage credentials"
ON public.artist_storage_credentials
...
-- Ensure no anonymous access to any storage credentials
-- This is implicitly handled by the policies above, but let's be explicit
