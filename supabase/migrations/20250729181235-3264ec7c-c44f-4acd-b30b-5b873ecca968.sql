...
-- Index for faster lookup of non-expired rates
CREATE INDEX idx_exchange_rates_active ON public.exchange_rates (base_currency, target_currency, expires_at) WHERE expires_at > now();
