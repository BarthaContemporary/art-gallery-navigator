...
const work = {
  ...
  fields: [
    ...
    { name: "makerNative", title: "Maker (kanji / native script)", type: "string" },
    {
      name: "artist",
      title: "Artist",
      type: "reference",
      to: [{ type: "artist" }],
      description: "Set by the sync from the inventory maker.",
    },
    { name: "year", title: "Year / date", type: "string" },
    { name: "provenance", title: "Provenance", type: "text", rows: 4 },
    { name: "literature", title: "Literature", type: "text", rows: 4 },
